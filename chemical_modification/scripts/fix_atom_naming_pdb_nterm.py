...
def extract_atom_info(str_file_path):
    ...
    for line in lines:
        ...
        if line.startswith("RESI") and "ntrm_fix" in line:
            line = line.replace("ntrm_fix", "NPC")
...
def update_pdb_file(pdb_file_path, atom_info):
    ...
    # Step 2: For all lines starting with ATOM, replace 4th column with NPC and 6th column with 1
    updated_lines2 = []
    for line in new_lines:
        if line.startswith("ATOM"):
            ...
            new_line = line[:17] + "NPC" + line[20:22] + "   1" + line[26:]
...
def main():
    str_file_path = 'ntrm.str'
    pdb_file_path = 'ntrm_fixed.pdb'
