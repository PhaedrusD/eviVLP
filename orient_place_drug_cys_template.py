...
def align_molecules(reference_pdb, one_pdb, output_pdb, 
                   ref_atoms=['CA', 'SG'], one_atoms=['*T1', '*T3'], 
    ...
    print(f"Target distance (SG-*T1): {target_distance:.3f} Å")
    print(f"Actual distance (SG-*T1): {actual_distance:.6f} Å")
