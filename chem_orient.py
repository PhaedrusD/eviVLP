...
u1 = mda.Universe("patch_YCLK.pdb")  # First protein (reference)
u2 = mda.Universe("azide2.pdb")      # Second protein (target)

# Select the specific atoms for translation
c_atom = u1.select_atoms("resid 139 and name C33")  # C-terminus carbon in the first protein
n_atom = u2.select_atoms("resid 1 and name N11")    # N-terminus nitrogen in the second protein
...
u2.atoms.write("C2.pdb")

# Write the coordinates of the first protein
u1.atoms.write("C1.pdb")


print("Files written: C1.pdb, C2.pdb")
